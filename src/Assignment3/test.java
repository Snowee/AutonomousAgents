...
public class test {
	...
	/*	for(int i = 0; i < game.statesArray.size(); i++){
			if(Collections.frequency(game.statesArray, game.statesArray.get(i)) > 1){
				...
				System.out.printf("Occurs %d times\n",Collections.frequency(game.statesArray, game.statesArray.get(i)) );
			...
			if(Collections.frequency(game.statesArray, game.statesArray.get(i)) > 1){
				...
				System.out.println(Collections.frequency(game.statesArray, game.statesArray.get(i)) );
			}*/
		//}
